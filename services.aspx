...
<asp:Content contentPlaceHolderId="Content" runat="server">
	...
	<div class="block">
		<h2>Ihre Präsenz auf mobilen Geräten</h2>
		<p>
		...
		<div class="details">
			...
			<ul>
				...
				<li>Optimiert für mobile Browser (iPhone, Google/Android phone oder einem anderen mobilen Gerät mit Webbrowser)</li>
	...
	<div class="block">
		...
		<p>
			Unterstützen Sie Ihre Businessprozesse durch eine massgeschneiderte Webapplikation.<br /> 
		...
		<div class="details">
			...
			<ul>
				<li>Gesicherter Zugriff mittels Webbrowser übers Internet (anytime, anywhere)</li>
				<li>Keine Ausgaben für teure Server (Hosting in der Cloud)</li>
