...
<asp:Content contentPlaceHolderId="Content" runat="server">
	...
	<div class="block">
		...
		<ul>
			...
			<li>Aufbau, Ausbau und Pflege von Kundenbeziehungen</li>
			<li>Aquirieren von Neukunden</li>
			<li>Erkennen und Entwickeln von Geschäftsmöglichkeiten</li>
			<li>Ausarbeiten von kundenspezifischen Roadmaps</li>
			<li>Kundenpräsentationen</li>
			<li>Pflege der Inhalte unserer Website</li>
	...
	<div class="block">
		...
		<ul>
			...
			<li>Sehr flexible und kommunikationsfreudige Persönlichkeit</li> 
